...
const pantalonesMujer = [
  ...
  },
  {
    ...
    name: "Leggings",
    price: 45,
    imageUrl: "/placeholder.svg?width=400&height=400&text=Leggings",
    handle: "leggings-mujer",
    isNew: true,
  },
]

export default function PantalonesMujerPage() {
  return (
    <div className="pt-16 min-h-screen bg-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Pantalones para Mujer</h1>
          <p className="text-gray-600">Pantalones femeninos para cada ocasión</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {pantalonesMujer.map((product) => (
